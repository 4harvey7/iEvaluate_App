  ...
  Future<void> _loadMetadata() async {
    ...
    if (mounted) {
      setState(() {
        ...
        // If both essential lists came back empty, the server or the network is
        // down. Flag it so the UI can show a retry prompt instead of empty pickers.
        if (depts.isEmpty && roles.isEmpty) {
          _errorMessage = 'Could not load registration data. Please check your internet connection and try again.';
        }
      });
    }
  }
