...
class Env {
  ...
  /// true  = call n8n directly (local dev, e.g. localhost:5678)
  /// false = route through Supabase Edge Function proxy (default)
  static const bool useDirectN8n =
      String.fromEnvironment('USE_DIRECT_N8N', defaultValue: 'false') == 'true';
