...
// in ievaluateapp_final/test/instructor/add_subject_screen_test.dart.
...
class _FakePostgrestQueryBuilder_18<T1> extends _i1.SmartFake
    implements _i2.PostgrestQueryBuilder<T1> {
  _FakePostgrestQueryBuilder_18(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _FakePostgrestBuilder_19<T1, S, R> extends _i1.SmartFake
...
class _FakeFuture_21<T1> extends _i1.SmartFake implements _i3.Future<T1> {
...
class _FakePostgrestTransformBuilder_22<T1> extends _i1.SmartFake
  ...
  _FakePostgrestTransformBuilder_22(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _FakeResponsePostgrestBuilder_23<T1, S, R> extends _i1.SmartFake
    implements _i2.ResponsePostgrestBuilder<T1, S, R> {
  _FakeResponsePostgrestBuilder_23(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
class MockPostgrestQueryBuilder<T> extends _i1.Mock
  ...
  _i2.PostgrestQueryBuilder<T> retry({required bool? enabled}) =>
      (super.noSuchMethod(
            ...
            returnValue: _FakePostgrestQueryBuilder_18<T>(
              this,
              Invocation.method(#retry, [], {#enabled: enabled}),
            ),
          )
